...
namespace andrey_rasputin_kt_42_20.Controllers
{
    [ApiController]
    [Route("prepod")]
    public class PrepodController : Controller
    {
        ...
        public IActionResult CreateKafedra([FromBody] andrey_rasputin_kt_42_20.Models.Kafedra kafedra)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public IActionResult DeleteKafedra(string kafedraName, andrey_rasputin_kt_42_20.Models.Kafedra updatedKafedra)
        {
            var existingKafedra = _context.Kafedra.FirstOrDefault(g => g.KafedraName == kafedraName);
